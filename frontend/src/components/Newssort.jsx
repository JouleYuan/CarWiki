...
class Newssort extends Component {
  ...
  handleTimeChange = (e) => {
    this.props.changenews_sort(e.target.value);
  }
  ...
  render() {
    ...
    return (
      ...
      <RadioGroup defaultValue="primary" aria-label="gender" name="customized-radios" onChange={this.handleTimeChange}>
        ...
        <FormControlLabel value="watch_count_asc" control={<StyledRadio />} label="点击量升序" />
        <FormControlLabel value="watch_count_desc" control={<StyledRadio />} label="点击量降序" />
      </RadioGroup>
    </FormControl>
      </div>
    )
...
export default withStyles(style)(Newssort);